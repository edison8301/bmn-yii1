...
<head>
    ...
    <title>Dokumen Pengembalian</title>
    <style>
        table {
            width: 100%;
...
<h4 style="font-weight: bold" class="text-center"> BERITA ACARA SERAH TERIMA PENGEMBALIAN</h4>
...
Dengan ini menyatakan bahwa PIHAK PERTAMA menyerahkan kepada PIHAK KEDUA, dan PIHAK KEDUA telah menerima penyerahan dari PIHAK PERTAMA untuk pengembalian ... (.....) unit BMN LAN berupa .......... dengan spesifikasi :
</p>
...
<ol>
    <li class="lh-sm" style="text-align:justify;">
        Dengan adanya Berita Acara Pengembalian ini maka PIHAK PERTAMA telah selesai dalam pemanfaatan BMN tersebut.
    </li>
    <li class="lh-sm" style="text-align:justify;">
       BMN dikembalikan dalam kondisi lengkap.
    </li>
</li>
